...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--exp_dir', default='result/',type=str, help='Path to experiment output directory')
		self.parser.add_argument('--checkpoint_path', default='../pretrained/best_model.pt', type=str, help='Path to model checkpoint')
		...
		self.parser.add_argument('--latents_test_path', default="../example_celebs.pt", type=str, help="The latents for the validation")
